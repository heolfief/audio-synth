...
#define sys_print_SDL_error(mesage)   // No print
...
#define sys_print_SDL_error(message) fprintf(stderr, "ERROR %s, %s : in function %s at %s (line %d)\n", message, SDL_GetError(), __func__, __FILE__, __LINE__)
#endif
